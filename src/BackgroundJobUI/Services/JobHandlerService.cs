                        ...
                        if (!getLocalDataYesterdayWeatherDataRes.Succeeded)//don't find
                        {
                            ...
                            if (historicalDataRes.Succeeded && historicalDataRes.Data != null)
                            {
                                ...
                                var createWeatherDataCommand = new CreateWeatherDataCommand()
                                {
                                    ...
                                    Pop = historicalData.Hourly.Any(x => x.Weather_id < 600) ? 1 : 0,
                                    ...
                                    Temp_morn = historicalData.Hourly[2].Temp,//9am
                                    Temp_day = historicalData.Hourly[8].Temp,//3pm
                                    Temp_eve = historicalData.Hourly[12].Temp,//7pm
                                    Temp_night = historicalData.Hourly[19].Temp,//2am
                                    WeatherId_morn = historicalData.Hourly[2].Weather_id,
                                    WeatherMain_morn = historicalData.Hourly[2].Weather_main,
                                    WeatherDesc_morn = historicalData.Hourly[2].Weather_description,
                                    WeatherIcon_morn = historicalData.Hourly[2].Weather_icon,
                                    WeatherId_day = historicalData.Hourly[8].Weather_id,
                                    WeatherMain_day = historicalData.Hourly[8].Weather_main,
                                    WeatherDesc_day = historicalData.Hourly[8].Weather_description,
                                    WeatherIcon_day = historicalData.Hourly[8].Weather_icon,
                                    WeatherId_eve = historicalData.Hourly[12].Weather_id,
                                    WeatherMain_eve = historicalData.Hourly[12].Weather_main,
                                    WeatherDesc_eve = historicalData.Hourly[12].Weather_description,
                                    WeatherIcon_eve = historicalData.Hourly[12].Weather_icon,
                                    WeatherId_night = historicalData.Hourly[19].Weather_id,
                                    WeatherMain_night = historicalData.Hourly[19].Weather_main,
                                    WeatherDesc_night = historicalData.Hourly[19].Weather_description,
                                    WeatherIcon_night = historicalData.Hourly[19].Weather_icon,
